...
import ratingRoutes from './models/valoraciones/valoracion.routes'; // Importa las rutas de valoraciones
...
app.use('/ratings', ratingRoutes); // Rutas de valoraciones (aquí deberías importar las rutas de valoraciones)
